...
import DashboarLayoutComponent  from './presentation/layouts/dashboar-layout/dashboar-layout.component';
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './presentation/pages/pro-const-stream-page/pro-const-stream-page.component'
          ),
        data: {
